 ...
 *   - The per-side rounded-corner path.
...
void DrawBackgroundImage(ldomNode *enode,LVDrawBuf & drawbuf,int x0,int y0,int doc_x,int doc_y, int width, int height, bool clip_to_target)
{
    ...
    if (!style->background_image.empty()) {
        ...
        int borderBoxAbsX0 = x0 + doc_x;
        int borderBoxAbsY0 = y0 + doc_y;
        int borderBoxW = width;
        int borderBoxH = height;
        ...
        if (!img.isNull() && width > 0 && height > 0) {
            ...
            */
            ...
            int rx[4]={0,0,0,0}, ry[4]={0,0,0,0};
            bool rounded = clip_to_target && computeBorderRadiiPx(enode, style.get(), borderBoxW, borderBoxH, rx, ry);
            lvRect orig_clip;
            if (clip_to_target)
            ...
            if (!rounded) {
                ...
                int oX0 = borderBoxAbsX0, oY0 = borderBoxAbsY0;
                int oX1 = oX0 + borderBoxW, oY1 = oY0 + borderBoxH;
                ...
                for (int y = padY0; y <= padY1; y++) {
                    ...
                    if (rowValid)
                        computeInnerSpanPerSide(y, oX0, oY0, oX1, oY1, rx, ry,
