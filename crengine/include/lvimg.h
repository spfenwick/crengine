...
/// (smooth only applies to a genuine two-axis IMG_TRANSFORM_STRETCH of a fixed-resolution
/// raster source; it's ignored for split/tile transforms and for scalable (SVG) sources,
/// which already render crisply at any size)
