...
// defined in lvrendborder.cpp) as it walks the tree, but the rounded/legacy
...
#ifndef __LVRENDBORDER_H_INCLUDED__
#define __LVRENDBORDER_H_INCLUDED__
...
#endif // __LVRENDBORDER_H_INCLUDED__
