...
// background-position is no longer a fixed set of keyword pairs: it is stored
// as two css_length_t values (background_position[0]=horizontal, [1]=vertical),
// so it can hold arbitrary <percentage> and <length> values, not just keywords.
